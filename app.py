...
def result():
    if request.method == 'POST':
        ...
        images, palettes, color_codes = get_style_samples(style)
        return render_template('result.html', style=style, images=images, palettes=palettes, color_codes = color_codes )
    else:
...
def get_style_samples(style):
    ...
    return images, palettes, color_codes
